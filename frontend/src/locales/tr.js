...
export default {
  ...
  'Body fat': 'Vücut yağı',
  'Log body fat': 'Vücut yağını kaydet',
  'Body fat 30d': 'Yağ 30 g',
  'Target body fat': 'Hedef yağ',
  'Calipers (JP3)': 'Kaliper (JP3)',
  'Manual %': 'Manuel %',
  'Estimated body fat': 'Tahmini yağ',
  'Recent body-fat logs': 'Son yağ kayıtları',
  'Age': 'Yaş',
  'reached!': 'ulaşıldı!',
  ...
  'Loudest also means highest. Your phone’s own volume is the master — press volume up while a rest is counting down, when the buttons control the timer rather than the ringer.': 'En yüksek aynı zamanda en tiz demek. Asıl belirleyici telefonun kendi sesi — bir dinlenme geri sayarken sesi açın; düğmeler o sırada zil sesini değil zamanlayıcıyı ayarlar.',
  'Low': 'Düşük',
  'Medium': 'Orta',
  'Loud': 'Yüksek',
  ...
  'Distance (m)': 'Mesafe (m)',
  'Farthest distance per workout': 'Antrenman başına en uzun mesafe',
  ...
  'Change date & time': 'Tarih ve saati değiştir',
  'Workout moved': 'Antrenman taşındı',
  'The session keeps its length. Personal records are worked out again from the new order.': 'Antrenmanın süresi korunur. Kişisel rekorlar yeni sıralamaya göre yeniden hesaplanır.',
  ...
  'Load {0}': '{0} yükle',
  '{0} short': '{0} eksik',
  'Plates split over both sides of a bar.': 'Diskler barın iki tarafına paylaştırılır.',
  'One stack — a belt, a landmine, a plate-loaded machine, a sled.': 'Tek yığın — bir kemer, bir landmine, diskli bir makine, bir kızak.',
  'No plate line under the sets.': 'Setlerin altında disk satırı yok.',
  'Base weight ({0})': 'Taban ağırlığı ({0})',
  'The whole weight is plates.': 'Ağırlığın tamamı disklerden oluşuyor.',
  'The machine or sled itself, before any plate goes on. 0 if it is all plates.': 'Herhangi bir disk takılmadan önceki makine veya kızağın kendi ağırlığı. Tamamı diskse 0 yap.',
  'Plates': 'Diskler',
  'Pairs of each size you own. Every set row loads from this list, so a home gym with one pair of 45s is never told to use two.': 'Sahip olduğun her ebattan çift sayısı. Her set satırı bu listeden yüklenir; bu yüzden yalnızca bir çift 45\'lik diski olan bir ev spor salonundan asla iki tane kullanması istenmez.',
  'pairs': 'çift',
  'Your own list for {0}.': '{0} için kendi listen.',
  'The standard set, plenty of each — change any count to make it yours.': 'Standart set, her birinden bolca — kendine göre yapmak için herhangi bir sayıyı değiştir.',
  'Back to the standard set': 'Standart sete dön',
  'Standard set — tap to count the pairs you own.': 'Standart set — sahip olduğun çiftleri saymak için dokun.',
  'You still log the total weight — this only feeds the plate line under each set.': 'Yine de toplam ağırlığı kaydedersin — bu yalnızca her setin altındaki disk satırına yarar.',
  ...
  'Workout updated': 'Antrenman güncellendi',
  'Save workout changes?': 'Antrenman değişiklikleri kaydedilsin mi?',
  'Save your edits to this workout, or keep the original record.': 'Bu antrenmandaki düzenlemelerini kaydet veya özgün kaydı koru.',
  ...
  'Training Volume': 'Antrenman Hacmi',
  'Frequency': 'Sıklık',
  'workouts': 'antrenman',
  'Not enough weeks of training yet.': 'Henüz yeterli antrenman haftası yok.',
  'Last 4 weeks vs. the 4 before:': 'Son 4 hafta, önceki 4 haftaya karşı:',
  'Personal Records': 'Kişisel Rekorlar',
  'No personal records yet.': 'Henüz kişisel rekor yok.',
  '+{0} more': '+{0} daha',
  'Needs Attention': 'Dikkat Gerekiyor',
  '{0} sessions without progressing': '{0} seanstır ilerleme yok',
  'No improvement in {0} sessions': '{0} seanstır gelişme yok',
}
