...
export default function RestTimer() {
  ...
  const { addRest, skipRest, stopRest, finishWorkEarly, stopWork } = useUI()
  ...
  return (
    <div id="timer" className="rest">
      ...
      <div className="acts">
        ...
        <Button size="sm" variant="primary" className="skip" onClick={timer.ready ? stopRest : skipRest}>{t(timer.ready ? 'Dismiss' : 'Skip')}</Button>
      </div>
    </div>
  )
}
